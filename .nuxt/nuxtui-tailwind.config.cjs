      ...
      const { customSafelistExtractor, generateSafelist } = require("/Users/milanherbe/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "/Users/milanherbe/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/Users/milanherbe/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
